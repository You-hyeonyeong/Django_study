"""
Django settings for firststudy project.
...
SECRET_KEY = '--^67%iv164aq*$1u5t^&id@r$k8uwszqg!i%w^4%7z8+=!mx='
...
WSGI_APPLICATION = 'firststudy.wsgi.application'
